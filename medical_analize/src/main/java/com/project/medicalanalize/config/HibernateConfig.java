...
@EnableJpaRepositories("com.project.medicalanalize.persistence.repository")
public class HibernateConfig {
    ...
    private static final String ENTITY_MANAGER_PACKAGES_TO_SCAN = "com.project.medicalanalize.persistence.entity";
