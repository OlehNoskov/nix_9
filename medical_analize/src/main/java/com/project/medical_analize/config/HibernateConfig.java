package com.project.medical_analize.config;
...
@EnableJpaRepositories("com.project.medical_analize.persistence.repository")
public class HibernateConfig {
    ...
    private static final String ENTITY_MANAGER_PACKAGES_TO_SCAN = "com.project.medical_analize.persistence.entity";
