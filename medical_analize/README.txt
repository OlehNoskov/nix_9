...
На главной страничке реализована общая информация о сервисе, а также ест ьнебольшой перечень научных публикаций.
...
- количество выполенненых заказов (разбитые по категориям)
