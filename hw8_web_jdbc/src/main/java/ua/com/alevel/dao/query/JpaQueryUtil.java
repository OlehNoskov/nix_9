...
public class JpaQueryUtil {
    ...
    public static final String UPDATE_STUDENT_BY_ID_QUERY = "UPDATE students SET age = ?, first_name = ?, last_name = ?, updated = ? WHERE id = ";
    public static final String DELETE_STUDENT_BY_ID_QUERY = "DELETE FROM students WHERE id = ";
    public static final String DELETE_STUDENT_BY_GROUP_ID_QUERY = "DELETE FROM students WHERE group_id = ";
