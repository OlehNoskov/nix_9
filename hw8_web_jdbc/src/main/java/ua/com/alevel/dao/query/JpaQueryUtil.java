...
public class JpaQueryUtil {
    ...
    public static final String UPDATE_BY_ID_QUERY = "UPDATE course SET name = ?, group_type = ?, updated = ? WHERE id = ";
    ...
    public static final String DELETE_STUDENTS_BY_GROUP_ID_QUERY = "DELETE FROM students WHERE course_id = ";
