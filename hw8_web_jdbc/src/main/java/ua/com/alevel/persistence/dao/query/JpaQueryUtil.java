...
public class JpaQueryUtil {
    ...
    public static final String FIND_ALL_STUDENTS_BY_GROUP_ID_QUERY = "SELECT * FROM students AS s JOIN course_student AS cs ON s.id = cs.student_id WHERE cs.course_id = ";
}